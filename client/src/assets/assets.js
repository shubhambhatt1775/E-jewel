...
import pendent from "./pendent.png";
...
export const footerLinks = [
  {
    ...
    links: [
      ...
      { text: "Contact Us", url: "/contect" },
      { text: "FAQs", url: "/contect" },
    ],
  },
  {
    title: "Need help?",
    links: [
      ...
      { text: "Return & Refund Policy", url: "/payment-methods" },
...
export const features = [
  {
    ...
    description: "Handcrafted jewellery with unmatched attention to detail.",
  },
  {
    icon: leaf_icon,
    title: "Timeless Elegance",
    description: "Designs that never go out of style, perfect for every occasion",
  },
  {
    icon: coin_icon,
    title: "Unmatched Value",
    description: "Luxury pieces at prices you’ll love.",
  },
  {
    icon: trust_icon,
    title: "Trusted by Thousands",
    description: "Adorned by 10,000+ happy customers worldwide.",
  },
];
